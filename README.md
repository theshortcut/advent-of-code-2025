...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `73.7µs` | `66.8µs` |
| [Day 2](./src/bin/02.rs) | `35.5ms` | `72.3ms` |
| [Day 3](./src/bin/03.rs) | `87.0µs` | `93.3µs` |
| [Day 4](./src/bin/04.rs) | `105.4µs` | `2.9ms` |
| [Day 5](./src/bin/05.rs) | `62.9µs` | `9.1µs` |
| [Day 6](./src/bin/06.rs) | `79.8µs` | `108.9µs` |
| [Day 7](./src/bin/07.rs) | `214.2µs` | `186.2µs` |
| [Day 8](./src/bin/08.rs) | `11.6ms` | `11.6ms` |
| [Day 9](./src/bin/09.rs) | `54.0ms` | `434.4ms` |
| [Day 10](./src/bin/10.rs) | `6.2ms` | `69.5ms` |
| [Day 11](./src/bin/11.rs) | `75.2µs` | `237.8µs` |
| [Day 12](./src/bin/12.rs) | `566.5ms` | `-` |
